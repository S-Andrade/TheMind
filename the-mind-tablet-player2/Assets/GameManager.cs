...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        PortInputField.GetComponent<InputField>().text = "7050";
        PlayerIDInputField.GetComponent<InputField>().text = "2";
    }
    ...
    {
        if (GameState == GameState.NextLevel || GameState == GameState.Mistake || GameState == GameState.UseStar || GameState == GameState.WaitingAnswer)
        {
